package com.gboissinot.devinci.streaming.data.module.analysis.indispo;
...
public class NbNotFreeDockStreamTopologyApp {
    ...
    public static void main(String[] args) {
        ...
        NbNotFreeDockStreamTopologyApp dockCountApp = new NbNotFreeDockStreamTopologyApp();
    ...
    private Topology createTopology() {
        ...
        KStream<String, String> onlyNonDisponible = docksCountStream.filter(
                new Predicate<String, String>() {
                    @Override
                    public boolean test(String key, String value) {
                        return value.equals("Hors communication");
                    }
                });
        onlyNonDisponible.to("belib-nbindispodocks-updates", Produced.with(stringSerde, stringSerde));
