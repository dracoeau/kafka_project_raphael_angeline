...
public class NbFreeDockStreamTopologyApp {
    ...
    private Topology createTopology() {
        ...
        KStream<String, String> onlyDisponible = docksCountStream.filter(
                new Predicate<String, String>() {
                    @Override
                    public boolean test(String key, String value) {
                        return value.equals("Disponible");
                    }
                });
        onlyDisponible.to("belib-nbdispodocks-updates", Produced.with(stringSerde, stringSerde));
